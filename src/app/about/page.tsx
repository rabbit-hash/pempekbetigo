    ...
    <div className="bg-white min-h-screen">
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="w-full md:w-1/2">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">A Legacy of Authentic Taste</h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <h2 className="text-3xl font-bold text-foreground mb-12">Meet the Team Behind the Kitchen</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
             {[1,2,3,4].map((i) => (
               <div key={i} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 text-center">
                  ...
                  <h4 className="text-lg font-bold text-foreground">Chef Master</h4>
